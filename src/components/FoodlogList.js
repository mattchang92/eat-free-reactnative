...
class FoodlogList extends React.Component {
  ...
  calculateFats(){
    ...
    for (var i=0; i<this.state.recipes.length; i++) {
      fats += (this.state.recipes[i].fats * this.state.foodlogs[i].servings)
    }
  ...
  calculateCarbs(){
    let carbs = 0;
    for (var i=0; i<this.state.recipes.length; i++) {
      carbs += (this.state.recipes[i].carbs * this.state.foodlogs[i].servings)
    }
  ...
  calculateCalories(){
    let calories = 0;
    for (var i=0; i<this.state.recipes.length; i++) {
      calories += (this.state.recipes[i].calories * this.state.foodlogs[i].servings)
    }
